...
export function NpcAuthoringPanel({
  ...
  return (
    ...
    >
      ...
      <section aria-labelledby="npc-coordinates-heading" className="space-y-2">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <h2
            id="npc-coordinates-heading"
        ...
        <div className="rounded-md border border-gray-800/90 bg-gray-950/40 p-3">
          <p className="text-xs text-gray-400">
            Current tile{" "}
            <span className="font-medium text-gray-200">
              row {row}, col {col}
          ...
          <p className={`mt-2 text-xs ${coordinateError ? "text-amber-300" : "text-gray-500"}`}>
